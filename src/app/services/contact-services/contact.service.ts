...
export class ContactService {
	//mock the server
	private KEY = 'CONTACTS_DB'
	private _contactsDb: Contact[] = this.utilService.load(this.KEY) || CONTACTS
	...
	public deleteContact(id: string) {
		...
		this.utilService.store(this.KEY, this._contactsDb)
	...
	private _addContact(contact: Contact) {
		...
		contact._id = this.utilService.getRandomId()
